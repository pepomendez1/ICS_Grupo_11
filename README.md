...
3. Objetivos del repositorio
4. Estructura del proyecto
5. Convenciones y reglas de nombrado
6. Ítems de configuración
7. Control de versiones
8. Líneas base del proyecto
...
Repositorio GitHub: agregar aquí el enlace al repositorio.
...
Cada trabajo práctico posee su propio directorio bajo la convención:
...
* Las fechas deberán expresarse utilizando el estándar ISO 8601:
...
Los trabajos prácticos se almacenarán en carpetas con la siguiente estructura:
...
El archivo de salida principal deberá utilizar la siguiente convención:

TP<nro>_Salida.<extension>
...
En caso de existir otros archivos necesarios para el desarrollo del TP:

TP<nro>_<descripcion>.<extension>
...
Las diapositivas deberán utilizar la siguiente convención:

<nro>_<tema>.<extension>

Donde <nro> representa el número correlativo de la presentación.
...
Los documentos correspondientes a bibliografía deberán utilizar:

<tema>_<titulo>.<extension>
...
Los apuntes deberán utilizar la siguiente convención:

<fecha>_<tema>.<extension>

La fecha deberá respetar el formato ISO 8601.
...
Se recomienda utilizar mensajes breves y descriptivos bajo la siguiente estructura:
...
Las líneas base se identificarán mediante tags de Git utilizando la siguiente estructura:

LB<nro>_TP<nro>_v<version>
...
Número entero utilizado como identificador de un elemento.

En determinados casos puede utilizarse de forma correlativa.
...
Número correlativo de dos dígitos utilizado para representar el orden de las diapositivas.
...
Fecha en la que se genera o incorpora un archivo al repositorio.

Se utiliza el estándar ISO 8601:
...
Palabra o conjunto de palabras que describen el contenido principal del archivo.
...
Título descriptivo utilizado para identificar el contenido específico de un documento.
...
Descripción breve y representativa del contenido de un archivo asociado a un trabajo práctico.
...
Número entero que identifica la versión correspondiente de una línea base.
...
Ingeniería y Calidad de Software · UTN FRC · Grupo 11.